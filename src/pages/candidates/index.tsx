...
export function CandidateListPage(props: CandidateListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getCandidates({
        ...
        order: params.order,
        searchTermKeys: ['previous_experience.contains', 'name.contains', 'email.contains', 'mobile.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    { id: 'previous_experience', header: 'Previous Experience', accessorKey: 'previous_experience' },
