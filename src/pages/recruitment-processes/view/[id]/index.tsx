...
import { getRecruitmentProcessById } from 'apiSdk/recruitment-processes';
import { RecruitmentProcessInterface } from 'interfaces/recruitment-process';

function RecruitmentProcessViewPage() {
          ...
          <>
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('recruitment_process', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/recruitment-processes/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              >
                ...
                <FormListItem label="Process Efficiency Score" text={data?.process_efficiency_score} />
              </List>
            </FormWrapper>
          </>
        )}
