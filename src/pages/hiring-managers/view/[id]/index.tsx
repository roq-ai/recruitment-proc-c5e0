...
import { getHiringManagerById } from 'apiSdk/hiring-managers';
import { HiringManagerInterface } from 'interfaces/hiring-manager';

function HiringManagerViewPage() {
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('hiring_manager', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/hiring-managers/edit/${id}`} passHref legacyBehavior>
                    <Button
