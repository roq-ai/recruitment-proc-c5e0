...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Job Application Submission.create': {
    roles: ['recruitment-manager', 'hr-specialist', 'recruitment-analyst', 'account-manager'],
    key: 'job_application',
    tenantPath: [],
    userPath: [],
  },
  'Interview Scheduled.create': {
    roles: ['hr-specialist', 'recruitment-analyst', 'account-manager'],
    key: 'interview_schedule',
    tenantPath: [],
    userPath: [],
  },
  'Job Offer Made.create': {
    roles: ['recruitment-manager', 'hr-specialist', 'recruitment-analyst'],
    key: 'job_offer',
    tenantPath: [],
    userPath: [],
  },
...
const ownerRoles: string[] = ['recruitment-manager'];
