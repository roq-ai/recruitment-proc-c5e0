...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const MockedLinkItems: Array<NavItemPropsInterface> = [
    ...
    { name: 'Candidates', path: '/candidates', entity: 'candidate', service: AccessServiceEnum.PROJECT, icon: FiUser },
    {
    ...
    { name: 'Interviews', path: '/interviews', entity: 'interview', service: AccessServiceEnum.PROJECT, icon: FiMic },
    {
    ...
    { name: 'Skills', path: '/skills', entity: 'skills', service: AccessServiceEnum.PROJECT, icon: FiTool },
